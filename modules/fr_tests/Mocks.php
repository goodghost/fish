...
require_once 'fr_services/includes/ServiceClient.inc';
require_once 'fr_services/includes/ServiceException.inc';
require_once 'fr_services/includes/HttpClientJSONFormatter.inc';
require_once 'fr_services/includes/ServiceClientAuth.inc';
require_once 'fr_services/includes/ServiceClientRequest.inc';

global $conf;
require_once __DIR__ . '/../../../settings/settings.services.php';
